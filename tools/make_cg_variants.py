...
def main() -> None:
    ...
    specs = [
        ...
        {"id": "cg_sleep_duplicate_voice_16x9", "role": "sleep", "trigger": "sleep_duplicate_voice", "source": "hallway", "tint": (48, 34, 88), "alpha": 86, "contrast": 1.38, "brightness": 0.62, "blur": 1.1, "shadow": {"x": 960, "y": 920, "scale": 0.82, "alpha": 118}, "lights": [{"position": [960, 460], "radius": 420, "color": [190, 95, 255], "alpha": 86}, {"position": [1280, 330], "radius": 300, "color": [90, 230, 255], "alpha": 58}]},
